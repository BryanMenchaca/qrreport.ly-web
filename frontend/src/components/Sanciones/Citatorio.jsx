...
const Citatorio = (props) => {
    const { fecha, motivo, observaciones, fechaCita, horaCita, folio, asistencia } = props;
    return (
        <div>
            ...
            <div className="d-flex">
                <p className="text-secondary mr-auto">
                    <small>Fecha y hora de cita:</small><br/>
                    <small className="text-dark">{fechaCita} a las {horaCita} hrs.</small>
                </p>
